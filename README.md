...
- **Chief Executive Officer** — аналіз завдання та визначення необхідних етапів. Якщо завдання просте (наприклад, гра в браузері), зайві фази (БД, безпека) автоматично пропускаються.
